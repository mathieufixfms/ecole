...
class School:
	...
	persons: list[Person] = field(default_factory=list, init=False)
	addresses: list[Address] = field(default_factory=list, init=False)
	...
	def display_addresss_list(self) -> None:
		for address in self.addresses:
			print(f"l'adresse est {address}")
			for person in address.persons_taking_it: # type: ignore
				print(f"- {person}")
			print()

	def display_students_list(self) -> None:
		for student in self.students:
			print(f"les étudiant sont : {student}")
